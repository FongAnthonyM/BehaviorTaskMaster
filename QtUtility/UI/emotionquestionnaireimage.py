...
class Ui_EmotionQuestionnaireImage(object):
    def setupUi(self, EmotionQuestionnaireImage):
        EmotionQuestionnaireImage.setObjectName("EmotionQuestionnaireImage")
    ...
    def retranslateUi(self, EmotionQuestionnaireImage):
        EmotionQuestionnaireImage.setWindowTitle(QtWidgets.QApplication.translate("EmotionQuestionnaireImage", "EmotionTaskQuestionnaire", None, -1))
        self.continueButton.setText(QtWidgets.QApplication.translate("EmotionQuestionnaireImage", "Next", None, -1))
        self.titleLabel.setText(QtWidgets.QApplication.translate("EmotionQuestionnaireImage", "Questionnaire", None, -1))
