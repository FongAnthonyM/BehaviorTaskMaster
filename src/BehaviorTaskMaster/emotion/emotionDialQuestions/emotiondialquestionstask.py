...
from ..emotionCategorization.UI import CategorizationParametersContainer
...
class EmotionDialQuestionsTask:
    ...
    def __init__(self, parent=None, stack=None, r_widget=None):
        ...
        self.parameters = CategorizationParametersContainer()
...
class ControlWidget(QWidget):
    ...
    def _construct_queue(self):
        ...
        self.add_item(self.queue_model, _id=0, washout=self.blocks[0]['washout'])
        for i, block in enumerate(self.blocks):
