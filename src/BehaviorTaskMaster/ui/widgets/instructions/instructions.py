...
# licensing of 'instructions.ui' applies.
#
...
class Ui_Instructions(object):
    def setupUi(self, Instructions):
        Instructions.setObjectName("InstructionsContainer")
        Instructions.resize(800, 600)
        self.gridLayout = QtWidgets.QGridLayout(Instructions)
        ...
        self.okButton = QtWidgets.QPushButton(Instructions)
        font = QtGui.QFont()
        ...
        self.backButton = QtWidgets.QPushButton(Instructions)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.backButton.setFont(font)
        self.backButton.setObjectName("backButton")
        self.gridLayout.addWidget(self.backButton, 5, 3, 1, 1)
        self.titleLabel = QtWidgets.QLabel(Instructions)
        ...
        self.textBrowser = QtWidgets.QTextBrowser(Instructions)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Instructions):
        Instructions.setWindowTitle(QtWidgets.QApplication.translate("InstructionsContainer", "InstructionsContainer", None, -1))
