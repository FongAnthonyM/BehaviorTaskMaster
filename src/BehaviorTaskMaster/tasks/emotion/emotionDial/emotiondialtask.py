...
from src.BehaviorTaskMaster.ui.widgets import InstructionsContainer, WashoutContainer, FinishContainer, VideoPlayerContainer
from src.BehaviorTaskMaster.ui.widgets import VideoPlayerControlContainer
from src.BehaviorTaskMaster.ui.widgets import VideoParametersContainer
...
class EmotionDialTask:
    ...
    def __init__(self, parent=None, stack=None, r_widget=None):
        ...
        self.parameters = VideoParametersContainer()
