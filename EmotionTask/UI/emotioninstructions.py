...
class Ui_EmotionInstructions(object):
    def setupUi(self, EmotionInstructions):
        EmotionInstructions.setObjectName("EmotionInstructions")
    ...
    def retranslateUi(self, EmotionInstructions):
        EmotionInstructions.setWindowTitle(QtWidgets.QApplication.translate("EmotionInstructions", "EmotionInstructions", None, -1))
        self.okButton.setText(QtWidgets.QApplication.translate("EmotionInstructions", "OK", None, -1))
        self.backButton.setText(QtWidgets.QApplication.translate("EmotionInstructions", "Back", None, -1))
        self.titleLabel.setText(QtWidgets.QApplication.translate("EmotionInstructions", "Instructions", None, -1))
